...
public class Practice12MeasureTextView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float statX = 50;
        canvas.drawText(text1, statX, 200, paint1);
        statX += paint1.measureText(text1);
        canvas.drawText(text2, statX, 200, paint2);
        statX += paint2.measureText(text2);
        canvas.drawText(text3, statX, 200, paint1);
    }
}
